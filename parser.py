...
if __name__ == "__main__":
    ...
    for firewall in firewalls["firewalls"]:
        fw = firewall["name"]
        firewall = get_firewall(fw, firewalls["firewalls"])
        rules_local, rules_forwarding = prepare_firewall(firewall, rules)
        write_rules(firewall, rules_local, rules_forwarding, config["general"]["workdir"])
